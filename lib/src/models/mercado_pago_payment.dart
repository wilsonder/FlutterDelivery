import 'package:flutter_delivery/src/models/mercado_pago_credit_cart.dart';
import 'package:flutter_delivery/src/models/mercado_pago_customer.dart';
import 'package:flutter_delivery/src/models/mercado_pago_tax.dart';
import 'package:flutter_delivery/src/models/mercado_pago_transaction_detail.dart';
...
class MercadoPagoPayment{
  ...
  static List<MercadoPagoPayment> fromJsonList(List<dynamic> jsonList) {
    List<MercadoPagoPayment> toList = [];

    jsonList.forEach((item) {
      MercadoPagoPayment model = MercadoPagoPayment.fromJson(item);
      toList.add(model);
    });
  ...
  MercadoPagoPayment.fromJson( Map<String, dynamic> json ) {
    id                        = json['id'].toString();
    ...
    payer                     = json['payer'] is MercadoPagoCustomer ? json['payer'] : MercadoPagoCustomer.fromJson(json['payer'] ?? {});
    ...
    // taxes                     = json['taxes'] is MercadoPagoTax ? json['taxes'] : MercadoPagoTax.fromJsonList(json['taxes']);
    ...
    transactionDetails        = json['transaction_details'] is MercadoPagoTransactionDetail ? json['transaction_details'] : MercadoPagoTransactionDetail.fromJson(json['transaction_details'] ?? {}) ;
    ...
    card                      = json['card'] is MercadoPagoCreditCard ? json['card'] : MercadoPagoCreditCard.fromJson(json['card'] ?? {});

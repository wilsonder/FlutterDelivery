...
class DeliveryOrdersMapPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DeliveryOrdersMapController> ( //coloca la imagen en el _imageUser una vez se haya seleccionado
  ...
  Widget _buttonAccept(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () => con.updateToDelivered(),
